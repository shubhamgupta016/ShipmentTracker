...
export async function POST(request){
    try{
        const query = `select u.userid, u.username, u.password, u.email, u.role, d.driverid, d.vehiclenumber, d.licensenumber, d.contactnumber from users u, drivers d where u.driverid = d.driverid`;
